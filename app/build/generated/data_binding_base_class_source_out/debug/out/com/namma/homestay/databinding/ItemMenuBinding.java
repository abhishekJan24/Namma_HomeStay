...
public final class ItemMenuBinding implements ViewBinding {
  ...
  private ItemMenuBinding(@NonNull MaterialCardView rootView, @NonNull TextView tvItemName,
  ...
  public static ItemMenuBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMenuBinding((MaterialCardView) rootView, tvItemName, tvPrice);
    }
